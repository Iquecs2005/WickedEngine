...
void Scene::DrawScene()
{
	...
	while (!stack.empty())
	{
		GameObjectPtr currentObject = stack.front();
...
GameObjectPtr Scene::CreateNewGameObject(std::string gameObjectName, GameObject* parent)
{
	GameObjectUniquePtr newGameObject = GameObject::Make(gameObjectName);
	...
	return GameObjectPtr(newGameObject);
}
